...
function OpenSourceCard() {
  ...
  return (
    <div className="relative border border-white/10 flex flex-col gap-10 p-[30px] md:p-[40px] bg-transparent rounded-xl md:flex-1 md:h-full overflow-hidden w-full h-[500px]">
