...
function PixelShiftFeature2Card() {
  return (
    <div
      className="flex flex-col bg-black rounded-[16px] md:flex-[1_0_0px] gap-[20px] justify-start overflow-hidden p-[30px] md:p-[40px] relative w-full border-[1px] border-solid border-white/10 h-[600px] md:h-full"
    ...
    >
      ...
      <div className="flex-[0_0_0px] h-[1px] w-full overflow-visible relative">
        <div className="absolute top-[20px] left-[-10%] w-[120%] h-[557px] flex-none">
          <section className="flex justify-start items-start w-full h-full place-items-center m-0 p-0 list-none opacity-1 overflow-hidden">
            <motion.ul
              animate={{ x: [0, -470, -965] }}
            ...
            >
              <li>
                <div className="h-[300px] w-[470px] flex flex-col gap-[10px]">
                  <div
                    className="w-full h-fit p-2 bg-white/10 rounded-xl flex justify-start items-center"
                    style={{
                  ...
                  <div className="w-full h-[500px] bg-white">
                    <img
                      src="/assets/WebsitePCVersion.png"
                      alt="Desktop View"
              ...
              <li>
                <div className="h-[350px] w-[270px] flex flex-col gap-[10px]">
                  ...
                  <div className="w-full h-[500px] bg-white">
                    <img
                      src="/assets/WebsiteTabVersion.png"
                      alt="Tablet View"
                      className="w-full h-full object-cover"
                    />
                  </div>
              ...
              <li>
                <div className="h-[350px] w-[200px] flex flex-col gap-[10px]">
                  ...
                  <div className="w-full h-[500px] bg-white">
                    <img
                      src="/assets/WebsiteMobileVersion.png"
                      alt="Mobile View"
                      className="w-full h-full object-cover"
                    />
                  </div>
